...
async def play(_, message: Message):
    ...
    try:
        ...
        user.first_name = "reisMusicVaves"
    usar = user
    wew = usar.id
    try:
    ...
    if audio:
        ...
        [
            [
                InlineKeyboardButton("🔖 𝖲𝗍𝖺𝗋 𝖬𝗎𝗓𝗂𝗄 𝖲𝗎𝗉𝗉𝗈𝗋𝗍", url=f"https://t.me/kelebekailesi"),
            ],
        ]
    )
        ...
        [
            [
                InlineKeyboardButton("🔖 flas 𝖬𝗎𝗓𝗂𝗄 𝖲𝗎𝗉𝗉𝗈𝗋𝗍", url=f"https://t.me/Starbotdestek"),
            ],
        ]
    )
