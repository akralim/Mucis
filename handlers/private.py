            ...
            [
                [
                    InlineKeyboardButton(
                        "➕ ❰ Grubuna Ekle ❱ ➕", url=f"https://t.me/Mucisflasbot?startgroup=true"
                    )
                ],
                [
                    InlineKeyboardButton(
                        "🔊 Asistan", url="https://t.me/Master_lockee"
                    ),
                    InlineKeyboardButton(
                        "💬 Sohbet", url="https://t.me/kelebekailesi"
                    )
                ],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "Resmi Kanal 🇹🇷", url=f"https://t.me/musicflase"
                    )
                ]
      ...
      reply_markup=InlineKeyboardMarkup(
             [
                 [
                     ...
                     InlineKeyboardButton(
                         "⚙ Geliştirici", url="https://t.me/Master_lockee")
                 ]
             ]
         )
    )
    ...
    await query.edit_message_text(f"""**Merhaba {query.from_user.mention} 🎵\nBen {bot}!\nSesli sohbetlerde müzik çalabilen botum. Ban yetkisiz, Ses yönetimi yetkisi verip, Asistanı gruba ekleyiniz.\n\nDüzen Tasarım [Talia Müzik 🎙️](https://t.me/Sohbetdestek).**""",
         reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "🔊 Asistan", url="https://t.me/asistanmucisflas"
                    ),
                    InlineKeyboardButton(
                        "💬 Sohbet", url="https://t.me/kelebekailesi"
                    )
